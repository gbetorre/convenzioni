 ...
 *   https://datatables.net/download/#dt/dt-2.3.5/b-3.2.5/cr-2.1.2/cc-1.1.1/r-3.0.7/sp-2.3.5
 *
 * Included libraries:
 *   DataTables 2.3.5, Buttons 3.2.5, ColReorder 2.1.2, ColumnControl 1.1.1, Responsive 3.0.7, SearchPanes 2.3.5
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.3.5/b-3.2.5/cr-2.1.2/cc-1.1.1/r-3.0.7/sp-2.3.5",
